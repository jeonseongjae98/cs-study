...
| 23/11/16 | [네트워크를 이루는 장치 #3 인터넷 계층, #4 데이터링크계층, #5 물리계층](./Contents/Network/네트워크를%20이루는%20장치%20%231%20애플리케이션%20계층.md)                                                                         | 권정훈 |
| 23/11/17 | [유선LAN의 기술 : 전이중화 통신, CSMA/CD](./Contents/Network/네트워크를%20이루는%20장치%20%232%20전송%20계층.md)                                                                                 | 하재률 |
| 23/11/24 | [무선LAN을 이루는 기술 : 반이중화 통신, CSMA/CA, 와이파이, BSS, ESS](./Contents/Network/유선LAN의%20기술%20-%20전이중화%20통신,%20CSMACD.md)                                                                      | 김도형 |
| 23/11/28 | [트랜잭션의 격리수준(SERIALIZABLE, REPEATABLE_READ 등)](./Contents/Network/무선LAN을%20이루는%20기술%20%20반이중화%20통신,%20CSMACA,%20와이파이,%20BSS,%20ESS.md)                       | 문준형 |
| 23/11/29 | [DEEP DIVE : clustered index와 non-clustered index와의 차이](./Contents/Network/DEEP%20DIVE%20-%20대규모%20트래픽으로%20인한%20서버%20과부화%20해결방법%20%231.md)                                     | 마성진 |
| 23/11/30 | [DEEP DIVE : 데이터베이스의 데드락과 해결방법](./Contents/Network/대규모%20트래픽으로%20인한%20서버%20과부화%20해결%20방법%232.md)                                                       | 전성재 |
